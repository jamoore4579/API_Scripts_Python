...
combined_output_file_path = r"c:\\users\\jmoore\\documents\\connectwise\\integration\\NS_Integration\\Inventory\\NSInventoryAddMW_output.csv"
...
def post_adjustment():
    ...
    try:
        for index, row in df.iterrows():
            ...
            payload = {
                "identifier": "NetsuiteConvert123124MW",
                "type": {"id": 3},
