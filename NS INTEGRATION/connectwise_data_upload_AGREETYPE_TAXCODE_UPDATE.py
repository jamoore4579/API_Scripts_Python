...
input_file_path = r"c:\users\jmoore\documents\connectwise\integration\NS_Integration\TaxCodes\CW_AgreeType_TaxCode_Output.csv"
output_file_path = r"c:\users\jmoore\documents\connectwise\integration\NS_Integration\TaxCodes\Updated_CW_AgreeType_TaxCode.csv"
...
for index, row in df.iterrows():
    ...
    url = f"{BASE_URL}/finance/agreements/types/{agree_type_id}"
    ...
    if response.status_code == 200:
        ...
        print(f"Failed to update work type ID {agree_type_id}. Status Code: {response.status_code}")
